	...
	<div id="demoWrapper">
		...
		<form id="demoForm" method="POST" action="fine.php" class="col-sm-6">
			<div id="fieldWrapper">
				...
				<span class="highlighth1">Insert Apartment Owner's Record</span>


				<input type="hidden" name="table" id="name" value="apartmentown" class="required" rel="0" />
				...
				<div class="form-group">
					...
					<div class="form-check">
						<input class="form-control" type="radio" name="cheque" value="Circle" checked="yes">Circle</>
						<input class="form-control" type="radio" name="cheque" value="Max">Max</>
						<input class="form-control" type="radio" name="cheque" value="Flexible">Flexible</>
