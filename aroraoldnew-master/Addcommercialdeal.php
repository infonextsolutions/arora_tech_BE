...
<head>
	...
	<div id="demoWrapper" class="container ">
		...
		<form id="demoForm" method="POST" class="col-sm-6" action="fine.php">
			...
			<div class="highlighth1">Insert a Commercial Dealer's Record</div>

			<input type="hidden" name="table" id="name" value="commercialdeal" class="required" rel="0" />
			...
			<div class="form-group">
				<label for="interested">File</label>
