...
$id = $_GET['id'];
$result = mysqli_query($GLOBALS['db'], "Select * from apartmentown where RID='$id'") or die(mysqli_error($GLOBALS['db']));
		...
		<div id="fieldWrapper"><span class="step" id="first">
				...
				<table class="table">
					...
					<tr>
						...
						<td>
							<input class="form-control   floor " type="text" name="floor" id="floor" value="<?php echo $row['floor'] ?>" />
						</td>
					</tr>
					<tr>
