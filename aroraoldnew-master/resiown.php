...
$id = $_GET['id'];
$result = mysqli_query($GLOBALS['db'], "Select * from resiplotown where RID='$id'") or die(mysqli_error($GLOBALS['db']));
		...
		<form id="demoForm" method="POST" action="Updateflooralt.php" class="">
			<div id="fieldWrapper">
				...
				<table class="table">
					...
					<input type="hidden" name="table" id="name" value="resiplotown" class="required" rel="0" />
					...
					<tr>
						...
						<td>
							...
							<div class="highlight">
								<input class="input_field_25em" type="radio" name="interested" value="Y" <?php if (strtolower($row['interested']) == 'y') echo 'checked'; ?>>Yes</>
								<input class="input_field_25em" type="radio" name="interested" value="N" <?php if (strtolower($row['interested']) == 'n') echo 'checked'; ?>>No </>
								<input class="input_field_25em" type="radio" name="interested" value="N" <?php if (strtolower($row['interested']) == '-') echo 'checked'; ?>>Dont know </>
						</td>
					</tr>
					<tr>
