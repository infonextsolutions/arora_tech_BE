...
<body>
	...
	<hr />
	<h5 id="status"></h5>
	<h4 class="text-center">Insert an owner's Record</h4>
	<div class="row">
		...
		<div class="col-md-6 ml-4">
			<form id="demoForm" method="POST" action="fine.php" class="">
				...
				<div class="form-group">
					...
					<input class="" type="radio" name="interested" value="Y">Yes</>
					<input class="" type="radio" name="interested" value="N">No</>
					<input class="" type="radio" name="interested" checked value="-">Dont know</>
				</div>
